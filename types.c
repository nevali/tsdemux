...
static const ts_streamtype_t streamtypes[] = {
	...
	{ ES_TYPE_DIGICIPHER2V, PT_PES, PST_VIDEO, "DigiCipher II", NULL, NULL },
	{ ES_TYPE_AC3, PT_PES, PST_AUDIO, "AC-3", "audio/ac3", "ac3" },
	{ ES_TYPE_DCA, PT_PES, PST_AUDIO, "HDMV DTS", NULL, "dts" },
	{ ES_TYPE_LPCM, PT_PES, PST_AUDIO, "LPCM", NULL, "pcm" },
	{ ES_TYPE_SDDS, PT_PES, PST_AUDIO, "SDDS", NULL, NULL },
	{ ES_TYPE_ATSC_PROGID, PT_DATA, PST_SI, "ATSC", NULL, NULL },
	{ ES_TYPE_DTSHD, PT_PES, PST_AUDIO, "DTS-HD", NULL, "dts" },
	{ ES_TYPE_EAC3, PT_PES, PST_AUDIO, "E-AC-3", "audio/x-eac3", "eac3" },
	{ ES_TYPE_DTS, PT_PES, PST_AUDIO, "DTS", NULL, "dts" },
	{ ES_TYPE_DVB_SLICE, PT_DATA, PST_UNSPEC, "DVB slice", NULL, NULL },
	{ ES_TYPE_AC3B, PT_PES, PST_AUDIO, "AC-3", "audio/ac3", "ac3" },
	{ ES_TYPE_SUBTITLE, PT_UNSPEC, PST_CC, "Subtitle", NULL, NULL },
	{ ES_TYPE_SDDSB, PT_PES, PST_AUDIO, "SDDS", NULL, NULL },
	/* MSCODEC ? */
